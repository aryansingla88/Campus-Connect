package com.example.campus_connect.adapter;
...
/*
LayoutInflater class's responsibility is to get xml file and create objects of everything created in it
 and then create a java object of the xml file
*/

import android.view.View;
/*
View is the base class for every UI element of android, it handles things like-
drawing itself on screen
user interaction (touch, tap etc)
visibility (visible, invisible gone).
*/

import android.view.ViewGroup;
/*
ViewGroup is itself a view but it can contain other views-
linear layout, constraint layout, grid layout are all ViewGroups
 */
...
/*
anything from androidx is a modern android library
@NonNull is an annotation i.e. a hint to the compiler and programmer that this value should never be null

RecyclerView is an advanced version of list view,
it works with adapter classes and view holder in collaboration to get json files of the posts from the backend
and properly display them in the recycler view on the app
 */
