...
data class ProfileStatsResponse(
    ...
    @SerializedName("club_count")       val clubCount       : Int,
    @SerializedName("interest_count")   val interestCount   : Int,
    @SerializedName("honor_count")      val honorCount      : Int,    // badges + medals
)